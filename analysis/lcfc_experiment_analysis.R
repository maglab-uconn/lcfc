...
ggsave("lcfc_experiment_n40_continua.png", width = 20, height = 20, units = "cm")

# 
# ggplot(df.goodSubj_resp_byBias_summary) + 
#   aes(step_scaled, front_response, color = context_bias, shape = context_bias) +
#   geom_point() + 
#   geom_line() +   
...
#        color = "Implied\nPoA for last\nsegment of\ncontext item",
#        shape = "Implied\nPoA for last\nsegment of\ncontext item") + 
#   theme(legend.position = c(0.72,0.75), legend.title.align = 0, legend.text.align = 1, 
#         panel.grid = element_blank())
